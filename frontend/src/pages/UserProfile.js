            ...
            <div className="profile-container">
                ...
                {editMode ? (
                    ...
                    <>
                        ...
                        <p><strong>Registration date:</strong> {new Date(userInfo.dateJoined).toLocaleString()}</p>
                        <button type="button" onClick={() => setEditMode(true)}>Edit Profile</button>
                        <button type="button" onClick={() => navigate('/myposts')}>My Post</button>
                    </>
                )}
                ...
                {emailEditMode ? (
                    <form onSubmit={emailStep === 1 ? handleSendVerificationCode : handleVerifyEmailCode}>
                        ...
                        <button class="admin-btn" onClick={() => { setEmailEditMode(false); setEmailStep(1); }}>Cancel</button>
                    </form>
                ) : (
                    <button type="button" onClick={() => setEmailEditMode(true)}>Change Email</button>
                )}
            </div>
